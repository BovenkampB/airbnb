...
function loadGeoJSON(geojson) {
    ...
    map.on('click', 'unclustered-point', function (e) {
        ...
        new mapboxgl.Popup()
            ...
            .setHTML('<h3>' + e.features[0].properties.name + '</h3> <br/> <img src=\"' + e.features[0].properties.thumbnailurl + '\" alt="Thumbnail" height="144" width="216" /> <p>' + e.features[0].properties.price + '</p><p> <a href="/Listings/Details/ ' + e.features[0].properties.id + '">Toon meer details</a></p>')
            .addTo(map);
